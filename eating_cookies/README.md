 ...
 * As far as performance optimizations go, caching/memorization might be one avenue we could go down? How should we make a cache available to our recursive function through multiple recursive calls?
