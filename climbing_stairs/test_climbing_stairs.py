...
class Test(unittest.TestCase):
    ...
    def test_climbing_stairs_large_n(self):
        ...
        self.assertEqual(climbing_stairs(
            500), 1306186569702186634983475450062372018715120191391192207156664343051610913971927959744519676992404852130396504615663042713312314219527)
