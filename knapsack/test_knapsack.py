...
class Test(unittest.TestCase):
  ...
  def setUp_medium(self):
    ...
    for line in file_contents.readlines():
      data = line.rstrip().split()
      self.medium_1_items.append({"name":int(data[0]), "weight":int(data[1]),"value": int(data[2])})
    ...
    for line in file_contents.readlines():
      data = line.rstrip().split()
      self.medium_2_items.append({"name":int(data[0]), "weight":int(data[1]),"value": int(data[2])})
    ...
    for line in file_contents.readlines():
      data = line.rstrip().split()
      self.medium_3_items.append({"name":int(data[0]), "weight":int(data[1]),"value": int(data[2])})
  ...
  def setUp_large(self):
    ...
    for line in file_contents.readlines():
      data = line.rstrip().split()
      self.large_1_items.append({"name":int(data[0]), "weight":int(data[1]),"value": int(data[2])})
